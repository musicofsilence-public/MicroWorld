...
constexpr MicroWorld::Messaging::FNameId InputEventChannel = MicroWorld::Messaging::MakeNameId("Ex19Input");

/** Motivation: Identifies the local-only channel carrying server state through Network. */
constexpr MicroWorld::Messaging::FNameId StateBroadcastChannel = MicroWorld::Messaging::MakeNameId("Ex19State");

/** Motivation: Filters the one application message accepted on the input channel. */
constexpr MicroWorld::Messaging::FNameId SpawnRequestMessageName = MicroWorld::Messaging::MakeNameId("Ex19Spawn");

/** Motivation: Filters the one application message accepted on the state channel. */
constexpr MicroWorld::Messaging::FNameId StateMessageName = MicroWorld::Messaging::MakeNameId("Ex19StateUpdate");
