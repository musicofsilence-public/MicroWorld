...
// ignores. This is example 16's Messaging and Network application protocol with every WiFi
// step deleted: the whole link is one wire, and only the device construction
...
/**
 * Motivation: Application entry point for example 19: the single ESP32 `app_main` stays a thin
