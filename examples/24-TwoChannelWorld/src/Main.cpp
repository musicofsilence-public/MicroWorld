...
// ignores. This example runs one engine-owned Messaging system over TWO simultaneous
// physical links (WiFi UDP telemetry + a UART command wire).
...
/**
 * Motivation: Application entry point for example 24: the single ESP32 `app_main` stays a thin
