...
- Publicly included Detail declarations use only plain integer configuration
...
exceptions disabled, and RTTI disabled. Check public Detail headers for vendor
