 ...
 */
constexpr FNetAddress MakeSpiAddress(const std::uint8_t NodeId) noexcept
{
	FNetAddress Address{};
 ...
 * value is validated when a driver actually routes the address. The one-byte UART, I2C, LoRa, and loopback
 ...
 */
constexpr bool IsSpiAddress(const FNetAddress& Address) noexcept
{
 ...
 */
constexpr std::uint8_t SpiAddressNodeId(const FNetAddress& Address) noexcept
{
