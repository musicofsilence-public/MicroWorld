...
`FEsp32E32LoraDriver`, and `WriteEsp32LogRecord` against the portable `INetDriver`,
`TimePointMilliseconds`, and `FOutputDeviceFunction` contracts; they may depend inward on
