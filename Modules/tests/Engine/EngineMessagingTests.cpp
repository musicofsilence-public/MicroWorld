 ...
 */
class FBeginPlayMessagingSubscriberActor final : public MicroWorld::Engine::AActor
{
public:
	/**
...
protected:
	...
	void BeginPlay() noexcept override
	{
		...
		const MicroWorld::Core::FWeakOwner Owner = MicroWorld::Engine::MakeWeakOwner(*ObjectStore, GetObjectHandle());
...
constexpr MicroWorld::Engine::FTypeId BeginPlayMessagingSubscriberActorTypeId{0x00080001u};
...
MW_TEST_CASE(EngineMessagingDestroyedActorOwnedSubscriptionIsSkippedAndReclaimed)
{
	...
	const EMessagingResult CreateChannelResult =
		MessagingSystem != nullptr ? MessagingSystem->CreateChannel(ChannelInformation) : EMessagingResult::Invalid;
	const MicroWorld::Engine::EObjectResult RegisterClassResult =
	...
	// Act
	const MicroWorld::Engine::EEngineResult SpawnResult =
		World.Get()->SpawnActor(MicroWorld::Engine::TObjectPtr<MicroWorld::Engine::AActor>{ActorCreation.Object});
	...
	const MicroWorld::Engine::EEngineResult DestroyResult =
		World.Get()->DestroyActor(MicroWorld::Engine::TObjectPtr<MicroWorld::Engine::AActor>{ActorCreation.Object});
	...
	// Assert
	MW_EXPECT_EQ(Test, MicroWorld::Engine::EObjectResult::Success, RegisterClassResult, "The BeginPlay subscriber actor class should register");
	...
	MW_EXPECT_EQ(Test, MicroWorld::Engine::EEngineResult::Success, SpawnResult, "The owner actor should queue for spawn");
	...
	MW_EXPECT_EQ(Test, MicroWorld::Engine::EEngineResult::Success, DestroyResult, "The owner actor should queue for destruction");
...
MW_TEST_CASE(EngineMessagingReclaimsDestroyedOwnerSubscriptionsAtDefaultCapacity)
{
	...
	constexpr std::size_t DefaultMessagingSubscriptionCapacity = MicroWorld::Messaging::FDefaultMessagingTraits::MaxSubscriptions;
	...
	const EMessagingResult CreateChannelResult =
		MessagingSystem != nullptr ? MessagingSystem->CreateChannel(ChannelInformation) : EMessagingResult::Invalid;
	const MicroWorld::Core::FWeakOwner Owner = MicroWorld::Engine::MakeWeakOwner(Engine.GetObjectStore(), ActorCreation.Object.Handle());
	...
	// Assert
	MW_EXPECT_EQ(Test, MicroWorld::Engine::EObjectResult::Success, RegisterClassResult, "The capacity owner actor class should register");
	...
	MW_EXPECT_EQ(Test, MicroWorld::Engine::EEngineResult::Success, RegisterActorResult, "The capacity owner actor should register with the world");
	MW_EXPECT_EQ(Test, ERuntimeResult::Success, BeginPlayResult, "The capacity owner world should begin play");
	MW_EXPECT_EQ(Test, MicroWorld::Engine::EEngineResult::Success, DestroyResult, "The capacity owner actor should queue for destruction");
...
MW_TEST_CASE(EngineMessagingStaleActorHandleOwnerSubscriptionIsInvalidAndNeverDelivers)
{
	...
	const bool bActorWasReclaimed = ActorCreation.Object.Get() == nullptr;
	const MicroWorld::Core::FWeakOwner StaleOwner = MicroWorld::Engine::MakeWeakOwner(Engine.GetObjectStore(), ActorHandle);
	FSubscriberDelegate Subscriber;
	...
	// Assert
	MW_EXPECT_EQ(Test, MicroWorld::Engine::EObjectResult::Success, RegisterClassResult, "The stale owner actor class should register");
	...
	MW_EXPECT_EQ(Test, MicroWorld::Engine::EEngineResult::Success, RegisterActorResult, "The stale owner actor should register with the world");
	MW_EXPECT_EQ(Test, ERuntimeResult::Success, BeginPlayResult, "The stale owner world should begin play");
	MW_EXPECT_EQ(Test, MicroWorld::Engine::EEngineResult::Success, DestroyResult, "The stale owner actor should queue for destruction");
