...
consumer: its Core-only images add `Modules/MicroWorld/Core`, while the LoRa image adds
the reusable `Modules/MicroWorld/Platform/Pico` package; all link the official Pico SDK and
