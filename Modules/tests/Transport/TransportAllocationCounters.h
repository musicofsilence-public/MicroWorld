 ...
 *
 * The Transport test executable defines one set of global operator-new overrides in
 * TransportAllocationCounters.cpp; every translation unit linked into that executable
