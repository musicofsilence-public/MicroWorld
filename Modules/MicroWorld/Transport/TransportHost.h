...
// the class body closes. Each definition is written as TTransportHost<MaxPeers,
// MaxPacketBytes>::Method so the public API in the class body stays compact while
// every method body stays visible at instantiation (the .inl files are never
// included directly).
#include "TransportHost_PeerTable.inl"
#include "TransportHost_Outbound.inl"
#include "TransportHost_ControlMessages.inl"
