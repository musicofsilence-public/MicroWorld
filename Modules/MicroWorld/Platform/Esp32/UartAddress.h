 ...
 */
constexpr Core::FDeviceAddress MakeUartAddress(const std::uint8_t InNodeId) noexcept
{
 ...
 */
constexpr bool IsUartAddress(const Core::FDeviceAddress& InAddress) noexcept
{
 ...
 */
constexpr std::uint8_t UartAddressNodeId(const Core::FDeviceAddress& InAddress) noexcept
{
