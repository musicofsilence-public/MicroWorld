 ...
 */
constexpr Core::FDeviceAddress MakeSpiAddress(const std::uint8_t InNodeId) noexcept
{
 ...
 */
constexpr bool IsSpiAddress(const Core::FDeviceAddress& InAddress) noexcept
{
 ...
 */
constexpr std::uint8_t SpiAddressNodeId(const Core::FDeviceAddress& InAddress) noexcept
{
